...
class Cow(models.Model):
    ...
    activity_status = models.CharField(max_length=20, null=True, blank=True, help_text="Activity status (Moving/Idle)")
    ...
    gyro_x = models.FloatField(null=True, blank=True, help_text="Gyroscope X axis")
    gyro_y = models.FloatField(null=True, blank=True, help_text="Gyroscope Y axis")
    gyro_z = models.FloatField(null=True, blank=True, help_text="Gyroscope Z axis")
    accel_x = models.FloatField(null=True, blank=True, help_text="Accelerometer X axis")
    accel_y = models.FloatField(null=True, blank=True, help_text="Accelerometer Y axis")
    accel_z = models.FloatField(null=True, blank=True, help_text="Accelerometer Z axis")
